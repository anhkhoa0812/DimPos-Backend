...
using Mediator;
using ValidationException = DimPos.Notification.Application.Common.Exceptions.ValidationException;

namespace DimPos.Notification.Application.Common.Behaviours;
