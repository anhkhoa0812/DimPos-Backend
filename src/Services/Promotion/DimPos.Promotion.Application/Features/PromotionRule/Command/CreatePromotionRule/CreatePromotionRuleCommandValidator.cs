...
public class CreatePromotionRuleCommandValidator : AbstractValidator<CreatePromotionRuleCommand>
{
    ...
    {
        RuleFor(x => x.Name)
            .NotEmpty().WithMessage("Tên của luật khuyến mãi không được để trống.")
            .NotNull().WithMessage("Tên của luật khuyến mãi không được để trống.")
            .MaximumLength(100).WithMessage("Tên của luật khuyến mãi không được vượt quá 100 ký tự.");
        RuleFor(x => x.ShortDescription)
            .NotEmpty().WithMessage("Mô tả ngắn của luật khuyến mãi không được để trống.")
            .NotNull().WithMessage("Mô tả ngắn của luật khuyến mãi không được để trống.")
        ...
        RuleFor(x => x.Priority)
            .NotNull().WithMessage("Ưu tiên của luật khuyến mãi không được để trống.")
...
public class CreateRuleActionRequestValidator : AbstractValidator<CreateRuleActionRequest>
{
    public CreateRuleActionRequestValidator()
    {
        ...
        RuleFor(x => x.Value)
            .NotEmpty().WithMessage("Giá trị của hành động không được để trống.")
            .NotNull().WithMessage("Giá trị của hành động không được để trống.");
