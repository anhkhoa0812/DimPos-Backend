...
public class GetPromotionRuleByIdResponse : GetPromotionRulesResponse
{
    public List<CampaignPromotionRuleResponse>? Campaigns { get; set; }
}
public class CampaignPromotionRuleResponse
{
