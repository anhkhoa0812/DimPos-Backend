...
public class CreateFinancialShiftConfigCommandValidator : AbstractValidator<CreateFinancialShiftConfigCommand>
{
    public CreateFinancialShiftConfigCommandValidator()
    {
