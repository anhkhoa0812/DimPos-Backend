...
namespace DimPos.Store.Infrastructure.Migrations
{
    ...
    [Migration("20250729140757_Fix_Releationship_Between_Store_With_FinancialShift")]
    partial class Fix_Releationship_Between_Store_With_FinancialShift
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DimPos.Store.Domain.Entities.StorePaymentMethodConfigs", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("CredentialsConfigAtStore")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("IsActiveByStore")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("StorePaymentMethodConfigs");
                });
            ...
            modelBuilder.Entity("DimPos.Store.Domain.Entities.StorePaymentMethodConfigs", b =>
                {
                    b.HasOne("DimPos.Store.Domain.Entities.Store", "Store")
                        .WithMany("StorePaymentMethodConfigs")
                        .HasForeignKey("StoreId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DimPos.Store.Domain.Entities.Store", b =>
                {
                    ...
                    b.Navigation("StorePaymentMethodConfigs");
