...
public class CreateInternalProductCommandValidator : AbstractValidator<CreateInternalProductCommand>
{
    public CreateInternalProductCommandValidator()
    {
        RuleFor(x => x.Code)
        ...
        RuleForEach(x => x.ProductImages).SetValidator(new CreateProductImageValidator());
    }
}

public class CreateProductImageValidator : AbstractValidator<CreateInternalProductImages>
{
